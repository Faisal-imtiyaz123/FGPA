...
module tb_fir_genvar();
    ...
    task write_outputs;
        ...
        begin
            f_950 = $fopen("out_950_genvar.txt", "w");
            f_1100 = $fopen("out_1100_genvar.txt", "w");
            f_2000 = $fopen("out_2000_genvar.txt", "w");
            ...
            $fclose(f_1100);
            $fclose(f_2000);
            $display("Written genvar outputs");
        end
    endtask
    
    initial begin
        $dumpfile("wave_genvar.vcd");
