...
module tb_fir_genvar_form();
    ...
    // Instantiate genvar FIR filter
    fir_genvar_form #(.TAPS(100)) uut (
        .clk(clk),
        .rst_n(rst_n),
        .x_in(test_input),
        .valid_in(valid_in),
    ...
    initial begin
        ...
        // Process signals
        process_signal("signal_950hz_q214.txt", "output_genvar_950hz.txt");
        process_signal("signal_1100hz_q214.txt", "output_genvar_1100hz.txt");
        process_signal("signal_2000hz_q214.txt", "output_genvar_2000hz.txt");
